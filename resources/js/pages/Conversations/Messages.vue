                        ...
                        <div class="flex-1 overflow-y-auto p-3">
                            <div class="space-y-2">
                                <div v-for="user in conversation.users" :key="user.id"
                                    ...
                                    <Avatar class="h-8 w-8">
                                        <AvatarFallback class="bg-gradient-to-r from-blue-500 to-purple-600 text-white text-xs">
                                    ...
                                    <div class="ml-3 flex-1 min-w-0">
                                        <p class="text-sm font-medium text-gray-900 dark:text-white truncate">
                                            {{ user.name }}
                                            <Badge v-if="user.id === currentUser?.id" variant="secondary" class="ml-1 text-xs">
                                                Vous
                                            </Badge>
                                        </p>
